...
from .views import welcome_page, register_view, login_view, logout_view, cart_view, menu_view, add_to_cart, make_order, all_orders_view, mark_order_as_done, user_orders_view, clear_cart, fill_menu, payment, payment_confirmation
