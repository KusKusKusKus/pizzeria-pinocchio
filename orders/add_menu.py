...
def add_menu():
    ...
    salad_types = [{'name': 'Овощной салат', 'price': Decimal('6.25')}, {'name': 'Greek Salad', 'price': Decimal('8.25')}, {'name': 'Antipasto', 'price': Decimal('8.25')}, {'name': 'Salad w/Tuna', 'price': Decimal('8.25')}]
