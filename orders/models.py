...
class PizzaType(models.Model):
    name = models.CharField(max_length=60, unique=True)
    price_sm_0 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_sm_1 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_sm_2 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_sm_3 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_sm_4 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_lg_0 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_lg_1 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_lg_2 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_lg_3 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
    price_lg_4 = models.DecimalField(max_digits=6, decimal_places=2, null=True)
...
class Pizza(models.Model):
    ...
    def __str__(self):
        return f"Пицца: {self.pizzatype.name} {self.get_pizza_size_display()} с {self.toppings.all().count()} позицией(ями)"
...
class Sub(models.Model):
    ...
    def __str__(self):
        if self.additional_cheese is False:
            return f"Дополнительно: {str(self.subtype)} {self.subsize}"
        else:
            return f"Дополнительно: {str(self.subtype)} {self.subsize} с дополнительным сыром"
...
class Pasta(models.Model):
    ...
    def __str__(self):
        return f"Паста: {str(self.pastatype)}"
...
class Salad(models.Model):
    ...
    def __str__(self):
        return f"Салат: {str(self.saladtype)}"
